...
The Problem (The Why): Stock data is difficult due to non-stationary patterns and noise. This project implements a stacked LSTM (Long Short-Term Memory) network to capture long-term dependencies in temporal data, moving beyond simple moving averages.
